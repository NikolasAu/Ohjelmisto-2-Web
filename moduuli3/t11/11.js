...
const closeimg = dialog.querySelector('span')
...
for (let pic of picArray) {
  ...
  arcticle.classList.add('card');
  arcticle.append(h2, figure, p);
  arcticle.addEventListener('click', function () {
    img.src = pic.image.large;
    img.alt = pic.title
    dialog.showModal();
  })

  section.append(arcticle)
}
